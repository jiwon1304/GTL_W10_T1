...
UStaticMeshTest* FResourceMgr::GetStaticMesh(FName InName) const
{
    auto* TempValue = StaticMeshMap.Find(InName);
    return TempValue ? *TempValue : nullptr;
}

USkeletalMesh* FResourceMgr::GetSkeletalMesh(FName InName) const
{
    auto* TempValue = SkeletalMeshMap.Find(InName);
    return TempValue ? *TempValue : nullptr;
}

void FResourceMgr::AddAssignStaticMeshMap(FName InName, UStaticMeshTest* InStaticMesh)
{
    StaticMeshMap.Add(InName, InStaticMesh);
}

void FResourceMgr::AddAssignSkeletalMeshMap(FName InName, USkeletalMesh* InSkeletalMesh)
{
    SkeletalMeshMap.Add(InName, InSkeletalMesh);
}
