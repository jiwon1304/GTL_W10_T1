...
public:
    ...
    void RenderPrimitive(const FStaticMeshRenderData& RenderData, TArray<FStaticMaterial*> Materials, TArray<UMaterial*> OverrideMaterials, int SelectedSubMeshIndex) const;
